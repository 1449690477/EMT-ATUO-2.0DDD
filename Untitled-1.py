    ...
    try:
        for macro in WQ70_INITIAL_MACROS:
            ...
            if macro == "map4-复位.json":
                ...
                if not wq70_wait(WQ70_WAIT_AFTER_MAP4):
                    return "abort"
        ...
        while True:
            for macro in WQ70_POST_WARNING_MACROS:
                ...
                if macro == "map5.json":
                    ...
                    if not wq70_wait(WQ70_WAIT_AFTER_MAP5):
                        return "abort"
...
def on_auto_bloom_toggle():
    if auto_bloom_var is None or auto_bloom_hotkey_var is None:
        return
...
def main():
    ...
    global auto_bloom_var, auto_bloom_hotkey_var
